...
!angular.$$csp().noInlineStyle&&!angular.$$uibTimepickerCss&&angular.element(document).find("head").prepend('<style type="text/css">.uib-time input{width:50px;}</style>'),angular.$$uibTimepickerCss=!0}),angular.module("ui.bootstrap.typeahead").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibTypeaheadCss&&angular.element(document).find("head").prepend('<style type="text/css">[uib-typeahead-popup].dropdown-menu{display:block;}</style>'),angular.$$uibTypeaheadCss=!0}),angular.module("app",["ngRoute","ngSanitize","ui.bootstrap"]),angular.module("app").run(["$templateCache",function(a){a.put("./about/about.html","<h1>About page</h1>"),a.put("./flowchart/flowchart.html",'<div clsas=row><div class="col-xs-9 col-xs-offset-3"><h1>How to buy a property owned by {{ctrl.owner.name}}</h1></div></div><div class=row><div class=col-xs-3><h3>Contents</h3><ol><li><a ng-click="ctrl.showStep(null, null)">About {{ctrl.owner.name}}</a></li><li ng-repeat="step in ctrl.steps"><a ng-click="ctrl.showStep(step.sequence, 0)">{{step.heading}}</a><ul ng-show="step.substeps.length > 1"><li ng-repeat="substep in step.substeps" ng-show=substep.ownerContent[ctrl.owner.ownerId]><a ng-click="ctrl.showStep(step.sequence, $index)">{{substep.heading}}</a></li></ul></li></ol></div><div class=col-xs-9><div class=flow-step ng-show=!ctrl.activeStep><h2>About {{ctrl.owner.name}}</h2><div ng-bind-html=ctrl.owner.introduction></div><h3>Contact information</h3><div ng-bind-html=ctrl.owner.contact></div></div><div class=flow-step ng-show=ctrl.activeStep><h2 ng-show=!ctrl.activeSubstep.heading>{{ctrl.activeStep.heading}}</h2><h2 ng-show=ctrl.activeSubstep.heading>{{ctrl.activeSubstep.heading}}</h2><div ng-bind-html=ctrl.activeSubstep.ownerContent[ctrl.owner.ownerId]></div></div></div></div>'),a.put("./home/home.html",'<div class=row><div class=col-xs-12><div class=jumbotron><h2>Kansas City Vacant Property</h2><h1>Rehabilitation Help</h1></div></div></div><div class=row><div class=col-xs-12><ng-include src="\'./search/search.html\'" ng-controller="SearchCtrl as ctrl"></ng-include></div></div>'),a.put("./menu/menu.html","<nav class=\"navbar navbar-inverse navbar-fixed-top\"><div class=container><ul class=\"nav navbar-nav\"><li ng-class=\"{active: ctrl.activePage === 'home'}\"><a class=navbar-brand href=#/home>[Home]</a></li><li ng-class=\"{active: ctrl.activePage === 'resources'}\"><a href=#/resources>Resources</a></li><li ng-class=\"{active: ctrl.activePage === 'about'}\"><a href=#/about>About</a></li><li ng-class=\"{active: ctrl.activePage === 'flowchart' && ctrl.params.ownerId === 'landbank'}\"><a href=#/flowchart/landbank>Land Bank</a></li><li ng-class=\"{active: ctrl.activePage === 'flowchart' && ctrl.params.ownerId === 'homesteadingauthority'}\"><a href=#/flowchart/homesteadingauthority>Homesteading Authority</a></li><li ng-class=\"{active: ctrl.activePage === 'flowchart' && ctrl.params.ownerId === 'government'}\"><a href=#/flowchart/government>Government</a></li><li ng-class=\"{active: ctrl.activePage === 'flowchart' && ctrl.params.ownerId === 'private'}\"><a href=#/flowchart/private>Private</a></li></ul></div></nav>"),a.put("./resources/resources.html",'<div class=row><div class=col-xs-12><h1>Resources and Ideas for Revitalizing Vacant Properties</h1></div><table class=table><tr><th>Resource</th><th>Description</th></tr><tr ng-repeat="r in ctrl.resources"><td class=lead><a ng-show=r.url ng-href={{r.url}} target=_blank>{{r.name}}</a> <span ng-hide=r.url>{{r.name}}</span></td><td>{{r.description}}</td></tr></table></div>'),a.put("./search/search.html",'<div id=search class="panel panel-default"><div class=panel-body><iframe id=search-map frameborder=0 src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJfwuYppf6wIcRkqd6whu_1T4&key=AIzaSyBO89Klnd28uyDC4FDFOW1Cxvqd2A5F-Ns" allowfullscreen></iframe><form><div class=form-group><label for=streetAddress>Address</label><input id=input-street-address class=form-control placeholder="Seach for a property by address" value="1911 Montgall Ave, Kansas City MO 64127"></div><button type=submit class="btn btn-primary">Search</button></form></div></div>')}]),angular.module("app").config(["$routeProvider",function(a){function b(a){return a.load()}function c(a){return a.load()}a.when("/about",{templateUrl:"./about/about.html",controller:"AboutCtrl",controllerAs:"ctrl",activePage:"about"}),a.when("/",{templateUrl:"./home/home.html",controller:"HomeCtrl",controllerAs:"ctrl",activePage:"home"}),a.when("/flowchart/:ownerId",{templateUrl:"./flowchart/flowchart.html",controller:"FlowchartCtrl",controllerAs:"ctrl",activePage:"flowchart",resolve:{fStore:b}}),b.$inject=["flowchartStore"],a.when("/resources",{templateUrl:"./resources/resources.html",controller:"ResourcesCtrl",controllerAs:"ctrl",activePage:"resources",resolve:{rStore:c}}),c.$inject=["resourceStore"],a.otherwise({redirectTo:"/"})}]),angular.module("app").constant("GOOGLE_WORKBOOK_ID","1Yw2NWmK5cEDDdlChs9SvyfHXKGlcO_qn56E4IeHdQ5Y"),angular.module("app").constant("GOOGLE_FLOWCHART_SHEET_ID","1"),angular.module("app").constant("GOOGLE_OWNERS_SHEET_ID","2"),angular.module("app").constant("GOOGLE_RESOURCES_SHEET_ID","3"),angular.module("app").controller("AboutCtrl",[function(){var a=function a(){_classCallCheck(this,a)};return new a}]),angular.module("app").controller("ComponentTemplateCtrl",[function(){var a=function a(){_classCallCheck(this,a)};return new a}]);var _createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}();angular.module("app").controller("FlowchartCtrl",["$routeParams","fStore",function(a,b){var c=function(){function c(){_classCallCheck(this,c),this.owner=b.owners[a.ownerId];var d=[];for(var e in b.steps){var f=b.steps[e];f.owners[this.owner.ownerId]&&d.push(f)}this.steps=d,this.activeStep=null,this.activeSubstep=null}return _createClass(c,[{key:"showStep",value:function(a,c){return null===a?(this.activeStep=null,void(this.activeSubstep=null)):(c=parseInt(c,10),this.activeStep=b.steps[a],void(this.activeSubstep=this.activeStep.substeps[c]))}}]),c}();return new c}]),angular.module("app").controller("HomeCtrl",[function(){var a=function a(){_classCallCheck(this,a)};return new a}]),angular.module("app").controller("MenuCtrl",["$rootScope","$route","$routeParams",function(a,b,c){var d=function d(){var e=this;_classCallCheck(this,d),a.$on("$locationChangeSuccess",function(){e.activePage=b.current.activePage,e.params=c})};return new d}]),angular.module("app").controller("ResourcesCtrl",["rStore",function(a){var b=function b(){_classCallCheck(this,b),this.resources=a.resources};return new b}]),angular.module("app").controller("SearchCtrl",[function(){var a=function a(){_classCallCheck(this,a)};return new a}]);var _createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}();angular.module("app").factory("flowchartStore",["$q","GOOGLE_WORKBOOK_ID","GOOGLE_FLOWCHART_SHEET_ID","GOOGLE_OWNERS_SHEET_ID","googleSpreadsheetData",function(a,b,c,d,e){function f(){if(m){var f=a.defer();return f.resolve(m),f.promise}var h={ownerData:e.load(b,d,g),flowchartData:e.load(b,c,i)};return a.all(h).then(function(a){return m=new l(a.ownerData,a.flowchartData)},function(b){return a.reject(b)})}var g=["flowchartheading","name","url","introduction","contactinfo"],h=function a(b){_classCallCheck(this,a),this.ownerId=b.flowchartheading.toLowerCase(),this.name=b.name,this.url=b.url,this.introduction=markdown.toHTML(b.introduction),this.contact=markdown.toHTML(b.contactinfo);for(var c=["ownerId","name","url","introduction","contact"],d=0;d<c.length;d++){var e=c[d];0===this[e].length&&(this[e]=this[e].trim(),this[e]=null)}},i=["stepsequence","heading","subheading","landbank","homesteadingauthority","government","private"],j=function(){function a(b){_classCallCheck(this,a),this.sequence=parseInt(b.stepsequence,10),this.heading=b.heading,this.substeps=[],this.owners={},this.__subseq=0}return _createClass(a,[{key:"addSubstep",value:function(a){this.substeps.push(new k(a,this,this.__subseq++))}}]),a}(),k=function a(b,c,d){_classCallCheck(this,a),this.heading=b.subheading.trim(),0===this.heading.length&&(this.heading=null),this.parentStep=c,this.sequence=d,this.ownerContent={};var e=["landbank","homesteadingauthority","government","private"],f=!0,g=!1,h=void 0;try{for(var i,j=e[Symbol.iterator]();!(f=(i=j.next()).done);f=!0){var k=i.value,l=b[k].trim();l.length>0&&(this.ownerContent[k]=markdown.toHTML(l),this.parentStep.owners[k]=!0)}}catch(a){g=!0,h=a}finally{try{!f&&j.return&&j.return()}finally{if(g)throw h}}},l=function a(b,c){_classCallCheck(this,a),this.owners={};var d=!0,e=!1,f=void 0;try{for(var g,i=b[Symbol.iterator]();!(d=(g=i.next()).done);d=!0){var k=g.value,l=k.flowchartheading.toLowerCase().trim();this.owners[l]=new h(k)}}catch(a){e=!0,f=a}finally{try{!d&&i.return&&i.return()}finally{if(e)throw f}}this.steps={};var m=0,n=!0,o=!1,p=void 0;try{for(var q,r=c[Symbol.iterator]();!(n=(q=r.next()).done);n=!0){var s=q.value,t=void 0,u=parseInt(s.stepsequence,10);u>=0?m=u:u=m,this.steps[u]?t=this.steps[u]:(t=new j(s),this.steps[u]=t),t.addSubstep(s)}}catch(a){o=!0,p=a}finally{try{!n&&r.return&&r.return()}finally{if(o)throw p}}},m=null;return{load:f}}]),angular.module("app").factory("googleSpreadsheetData",["$http","$q",function(a,b){function c(c,e,f){var g=c+"+"+e;if(d[g]){var h=b.defer();return h.resolve(d[g]),h.promise}var i="https://spreadsheets.google.com/feeds/list/"+c+"/"+e+"/public/values?alt=json";return a({method:"GET",url:i}).then(function(a){var c=void 0,e=[],h=!0,i=!1,j=void 0;try{for(var k,l=a.data.feed.entry[Symbol.iterator]();!(h=(k=l.next()).done);h=!0){c=k.value;var m=void 0,n={},o=!0,p=!1,q=void 0;try{for(var r,s=f[Symbol.iterator]();!(o=(r=s.next()).done);o=!0){m=r.value;var t="gsx$"+m;if(!c[t]){var u='column "'+m+'" not Found';return console.error(u),b.reject(u)}n[m]=c[t].$t}}catch(a){p=!0,q=a}finally{try{!o&&s.return&&s.return()}finally{if(p)throw q}}e.push(n)}}catch(a){i=!0,j=a}finally{try{!h&&l.return&&l.return()}finally{if(i)throw j}}d[g]=e;var v=b.defer();return v.resolve(d[g]),v.promise},function(a){return b.reject(a)})}var d={};return{load:c}}]),angular.module("app").factory("resourceStore",["$q","GOOGLE_WORKBOOK_ID","GOOGLE_RESOURCES_SHEET_ID","googleSpreadsheetData",function(a,b,c,d){function e(){if(h){var e=a.defer();return e.resolve(h),e.promise}return d.load(b,c,f).then(function(b){h=new g(b);var c=a.defer();return c.resolve(h),c.promise},function(b){return console.error(b),a.reject(b)})}var f=["name","description","url"],g=function a(b){_classCallCheck(this,a),this.resources=b},h=null;return{load:e}}]),angular.module("app").factory("factoryName",[function(){}]);
//# sourceMappingURL=v2v.min.js.map